...
slot_t
new_slot(int node_id, int it, double start_time, double duration)
{
    slot_t s = NULL;
...
slot_t
search_a_slot(m_cluster_t cluster, int node_id, int it, 
		     double start_time, double end_time, double duration)
{
    ...
    if (start_time < end_time)
        return search_a_slot(cluster, node_id, it, end_time, end_time,
                             duration);
